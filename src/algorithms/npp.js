...
console.log(npp(arrivalTime1, burstTime1, priorities1));

const arrivalTime2 = [0, 2, 4];
const burstTime2 = [8, 10, 6];
const priorities2 = [3, 1, 2];
console.log(npp(arrivalTime2, burstTime2, priorities2));

const arrivalTime3 = [0, 1, 2];
const burstTime3 = [4, 5, 3];
const priorities3 = [1, 1, 1];
console.log(npp(arrivalTime3, burstTime3, priorities3));

const arrivalTime4 = [0];
const burstTime4 = [5];
const priorities4 = [2];
console.log(npp(arrivalTime4, burstTime4, priorities4));

const arrivalTime5 = [0, 0, 0];
const burstTime5 = [4, 5, 3];
const priorities5 = [1, 2, 3];
console.log(npp(arrivalTime5, burstTime5, priorities5));