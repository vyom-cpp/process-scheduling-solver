...
// Test cases
const arrivalTime1 = [0, 1, 2, 3];
const burstTime1 = [7, 4, 1, 4];
console.log("Test Case 1:");
console.log(sjf(arrivalTime1, burstTime1));

const arrivalTime2 = [0, 1, 2, 3, 4];
const burstTime2 = [5, 4, 3, 2, 1];
console.log("Test Case 2:");
console.log(sjf(arrivalTime2, burstTime2));

const arrivalTime3 = [0, 2, 4, 6, 8];
const burstTime3 = [5, 4, 3, 2, 1];
console.log("Test Case 3:");
console.log(sjf(arrivalTime3, burstTime3));